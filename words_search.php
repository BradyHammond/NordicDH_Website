...
<?php
  ...
  if(strpos($header, "1000 Word Chunks") == true)
  {
    $chunk_size = "1000";
    $check_id_I .= "1000";
  }
  
  else if(strpos($header, "1500 Word Chunks") == true)
  {
    $chunk_size = "1500";
    $check_id_I .= "1500";
  }
  ...
  if(strpos($header, "(Nouns Only)") == true)
  {
    $part_of_speech = "N";
    $check_id_I .= "N_";
  }
  ...
  if(strpos($header, "25 Topics") == true)
  {
    $topic_number = "25";
  }
  
  else if(strpos($header, "40 Topics") == true)
  {
    $topic_number = "40";
  }
  
  else if(strpos($header, "55 Topics") == true)
  {
    $topic_number = "55";
  }
      ...
      <table class="table table-inverse" id="topic-table">
        ...
        <tbody>
          <?php
            ...
            {
              if(preg_match($check_id_I, $value[0]) && preg_match($check_id_II, $value[0]))
              {
                $id = $value[0];
            	...
            	if(!empty($user))
            	{
            	  echo "<td style='vertical-align: middle;' class='pointer' onclick='transform_tag(this)' id='".$word_query_part_II_results[0][2].",".$number."'>".$name."</td>";
		}
		...
		echo "<td id='bar_graphic_".$i."' class='bar_graphic_".$i."' width='90%'>";
                echo "</td>";
                echo "</tr>";
...
<!--==================================================-->
    ...
    <script type="text/javascript">
      ...
      var width = "90%";
      var height = 175;
      var true_width = document.getElementById("bar_graphic_0").clientWidth;
            ...
            .append('rect')
              ...
              {  
                return true_width/dataset.length - 5;
       	      ...
       	      {
       	        if (d.word == "<?php echo $word; ?>".toLowerCase())
       	        {
       	          return "rgb(255, 0, 0)";
       	        }
       	        else
